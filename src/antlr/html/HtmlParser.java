...
public class HtmlParser extends Parser {
	...
	public static final int
		XML=1, DTD=2, SCRIPTLET=3, SEA_WS=4, TAG_OPEN=5, TAG_NAME=6, TAG_CLOSE=7, 
		TAG_SLASH=8, TAG_SLASH_CLOSE=9, CDATA=10, TAG_EQUALS=11, ATTVALUE_VALUE=12, 
		HTML_TEXT=13, HTML_COMMENT=14, HTML_CONDITIONAL_COMMENT=15, SCRIPT_OPEN=16, 
		SCRIPT_BODY=17, SCRIPT_SHORT_BODY=18, STYLE_OPEN=19, STYLE_BODY=20, STYLE_SHORT_BODY=21;
	public static final int
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			null, "XML", "DTD", "SCRIPTLET", "SEA_WS", "TAG_OPEN", "TAG_NAME", "TAG_CLOSE", 
			"TAG_SLASH", "TAG_SLASH_CLOSE", "CDATA", "TAG_EQUALS", "ATTVALUE_VALUE", 
			"HTML_TEXT", "HTML_COMMENT", "HTML_CONDITIONAL_COMMENT", "SCRIPT_OPEN", 
			"SCRIPT_BODY", "SCRIPT_SHORT_BODY", "STYLE_OPEN", "STYLE_BODY", "STYLE_SHORT_BODY"
		};
	}
	...
	public final HtmlDocumentContext htmlDocument() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 639032L) != 0)) {
				{
				{
				setState(46);
				htmlElements();
	...
	public final HtmlElementsContext htmlElements() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 49168L) != 0)) {
				{
				{
				setState(54);
				htmlMisc();
